package com.github.quiram.course.collectors.h.errors;
...
import static com.github.quiram.course.collectors.h.errors.collector.Collectors.toListOf;
...
public class Program {
    ...
    private static List<MotorVehicle> taxableVehicles() {
        return vehicles.stream()
                ...
                .collect(toListOf(MotorVehicle.class));
    }
}
