package com.github.quiram.course.collectors.d.verbosity;
...
import static com.github.quiram.course.collectors.d.verbosity.collector.Collectors.toSingleton;
        ...
        while (scanner.hasNextLine()) {
            ...
            try {
                final Command command = commands.stream()
                        ...
                        .collect(toSingleton(
                                format("No command supports input '%s'", input),
                                list -> "Ambiguous input, all these commands apply: " + list
                        ));
